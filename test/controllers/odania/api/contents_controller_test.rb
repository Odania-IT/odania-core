...
class Odania::Api::ContentsControllerTest < ActionController::TestCase
	...
	test 'test should get index' do
		get :index, {language_id: @menu.language_id, site_id: @site.id, format: :json}
		assert_response :success
	end

	test 'test should show content' do
		get :show, {id: @content.id, language_id: @menu.language_id, site_id: @site.id, format: :json}
		assert_response :success
	end

	test 'test should give error on invalid id' do
		get :show, {id: 'asd65dsadsatest-test', language_id: @menu.language_id, site_id: @site.id, format: :json}
