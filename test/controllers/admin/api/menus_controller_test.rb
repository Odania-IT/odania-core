...
class Admin::Api::MenusControllerTest < ActionController::TestCase
	...
	test 'test should get index' do
		get :index, params: {site_id: @site.id, format: :json}
		assert_response :success
	end

	test 'test should show content' do
		get :show, params: {id: @menu.id.to_s, site_id: @site.id, format: :json}
		assert_response :success
	end

	test 'test should redirect on invalid id' do
		get :show, params: {id: 'asd65dsadsatest-test', site_id: @site.id, format: :json}
	...
	test 'should create content' do
		...
		assert_difference 'Odania::Menu.count' do
			post :create, params: {menu: data, site_id: @site.id, format: :json}
		end
		assert_response :success
	end
	...
	test 'should update content' do
		data = {title: 'Test Title', published: true, language_id: @content.language_id}
		post :update, params: {id: @menu.id.to_s, menu: data, site_id: @site.id, format: :json}
		assert_response :success
	end

	test 'should destroy content' do
		assert_difference 'Odania::Menu.count', -1 do
			delete :destroy, params: {id: @menu.id.to_s, site_id: @site.id, format: :json}
		end
		assert_response :success
	end
end
