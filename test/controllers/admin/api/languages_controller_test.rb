...
class Admin::Api::LanguagesControllerTest < ActionController::TestCase
	...
	test 'test should show content' do
		get :show, id: @language.id.to_s, format: :json
		assert_response :success
	end
	...
	test 'should create content' do
		...
		assert_difference 'Odania::Language.count' do
			post :create, {language: data, format: :json}
		end
		assert_response :success
	end
	...
	test 'should update content' do
		...
		post :update, {id: @language.id.to_s, language: data, format: :json}
		assert_response :success
	end

	test 'should destroy content' do
		assert_difference 'Odania::Language.count', -1 do
			delete :destroy, id: @language.id.to_s, format: :json
		end
		assert_response :success
	end
end
