...
class Admin::Api::ContentsControllerTest < ActionController::TestCase
	...
	test 'test should show content' do
		get :show, params: {id: @content.id.to_s, menu_id: @menu.id.to_s, site_id: @site.id, format: :json}
		assert_response :success
	end
	...
	test 'should create content' do
		...
		assert_difference 'Odania::Content.count' do
			post :create, params: {content: data, menu_id: @menu.id.to_s, site_id: @site.id, format: :json}
		end
		assert_response :success
	end
	...
	test 'should update content' do
		...
		post :update, params: {id: @content.id.to_s, content: data, menu_id: @menu.id.to_s, site_id: @site.id, format: :json}
		assert_response :success
	end

	test 'should destroy content' do
		assert_difference 'Odania::Content.count', -1 do
			delete :destroy, params: {id: @content.id.to_s, menu_id: @menu.id.to_s, site_id: @site.id, format: :json}
		end
		assert_response :success
	end
end
