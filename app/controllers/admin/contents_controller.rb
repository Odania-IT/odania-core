class Admin::ContentsController < ApplicationController
	...
	def destroy
		...
		redirect_to admin_contents_url, notice: 'Content was successfully destroyed.'
	end
	...
	def set_admin_content
		...
		redirect_to admin_contents_path if @admin_content.nil?
	end

	# Only allow a trusted parameter "white list" through.
	def admin_content_params
		params.require(:admin_content).permit(:title, :body, :body_short, :published_at, :language)
	end
end
