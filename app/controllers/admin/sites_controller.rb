class Admin::SitesController < ApplicationController
	...
	def set_admin_site
		...
		redirect_to admin_sites_path if @admin_site.nil?
	end

	# Only allow a trusted parameter "white list" through.
	def admin_site_params
		params.require(:admin_site).permit(:name, :host, :is_active, :is_default, :tracking_code, :description, :language, :redirect_to, :template)
	end
end
