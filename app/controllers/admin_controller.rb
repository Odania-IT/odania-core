class AdminController < ApplicationController
	...
	def choose_site
		...
		@admin_site = Odania::Site.where(_id: site_id).first unless site_id.nil?
		@admin_site = Odania::Site.where(_id: session[:site_id]).first if @admin_site.nil? and !session[:site_id].nil?
